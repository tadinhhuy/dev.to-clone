...
import { RxBookmark, RxChatBubble } from 'react-icons/rx';
  ...
  return (
    <Card className={clsx('p-5')}>
      <div className="mb-2 flex items-center">
        <Avatar src={avatarMock} alt="avatar" className="h-8 w-8 pr-2 hover:bg-transparent" />
        <div>
          <GhostButton className="m-[-4px] px-1 py-2">
            <p className="text-sm text-[#3D3D3D]">{title}</p>
          </GhostButton>
          <p className="text-xs text-[#525252]">{date}</p>
        </div>
      </div>
      <div className="pl-10">
        <h2 className="mb-1 break-words text-2xl font-bold text-neutral-900 hover:text-[#2F3AB2]">
          <Link to={''}>title</Link>
        </h2>
        ...
        <div className="ml-[-8px] flex items-center justify-between">
          <div className="flex">
            <GhostButton>{reactionsCount} reactions</GhostButton>
            <GhostButton>
          ...
          <div className="flex items-center">
            <p className="mr-2 text-xs text-[#525252]">{readingTimeMinutes} min read</p>
            <Button variant="text" className="px-2 py-2 text-2xl">
              <RxBookmark />
            </Button>
          </div>
        </div>
